...
public class WritingCreateActivity extends AppCompatActivity {
    ...
    EditText writing_text,writing_title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writing_title = (EditText) findViewById(R.id.writing_title_create);
...
//                }
                addWriting(title,result,userid,getTime());
                Bulletinboard_clear();
                finish();
    ...
    // 커뮤니티 -> 게시판 -> 글
    private void addWriting(String title,String result, String userid, String Time){
        //animal.java에서 선언했던 함수.
        WritingListItem WritingListData = new WritingListItem(result,userid,Time,title);
    ...
    public void Bulletinboard_clear(){
        int count = Bulletinboard_adapter.getCount();
        for(int i = 0;i<count;i++){
            Bulletinboard_adapter.clear();
        }
    }
}